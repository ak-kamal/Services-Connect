...
function Home() {
  ...
  const categories = [
    ...
    {
      title: 'Drivers',
      description: 'Personal driving, pickup-drop and daily transportation support.',
    },
  ]
        ...
        <div className="hero-content text-center">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold">
              Book trusted home service providers with ease
            </h1>
            <p className="py-6 text-base-content/80">
              Services Connect helps you find reliable electricians, plumbers,
              carpenters and drivers whenever you need them.
            </p>
